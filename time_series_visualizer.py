...
def draw_line_plot():
    # Draw line plot
    fig = df.plot.line(figsize=(32,10), color='red', legend=False);
...
def draw_bar_plot():
    ...
    # Draw bar plot
    fig = df_bar_group.plot.bar(figsize=(12,12)).figure
    plt.xlabel('Years');
...
def draw_box_plot():
    ...
    # Draw box plots (using Seaborn)
    fig, axes = plt.subplots(1, 2, figsize=(36git branch -M main, 14), dpi=100)
